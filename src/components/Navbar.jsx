...
const Navbar = ({ setShowSignUp, setShowSignIn, onRefreshChat }) => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        ...
        !friendsMenuRef.current.contains(event.target)
      ) {
  ...
  const ProfileMenuDesktop = () => (
    <div className="relative m-auto pl-12" ref={menuRef}>
      ...
      {showMenu && (
        <div
          className="absolute right-0 md:w-80 w-64 bg-[#020202] border border-[#272727] rounded-xl 
          ...
          <div className="p-2">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-sm text-red-400/70 truncate">
  ...
  const FriendsNavItem = () => (
    <div className="relative" ref={friendsMenuRef}>
      ...
      >
        ...
        <span className="relative transform transition-all duration-200 group-hover:translate-x-0.5">
          Friends
        </span>
        <IoMdArrowDropdown
          className={`text-xl transition-all duration-300 ${
            showFriendsMenu ? "rotate-180" : ""
      ...
      {showFriendsMenu && (
        <div
          className="absolute top-full right-0 md:w-80 w-64 bg-[#020202] border border-[#272727] rounded-xl 
                               shadow-2xl z-50 animate-fadeUp origin-top-right"
          style={{ maxWidth: "calc(100vw - 2rem)" }}
        >
          <div className="p-4 border-b border-[#272727]">
              ...
              <>
                {publicNavItems.map((item, index) => (
                  <li key={index} className="relative group">
                    ...
                    <div
                      className="absolute top-full left-1/2 -translate-x-1/2 w-max opacity-0 invisible
