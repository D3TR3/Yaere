...
import { searchUserByUsername, sendFriendRequest, getFriendStatus } from '../firebase/firestore';
...
const FindFriends = ({ isOpen, onClose }) => {
    ...
    const handleSearch = async (e) => {
        ...
        if (rateLimiters.search.isRateLimited(currentUser.uid)) {
            const remainingTime = rateLimiters.search.getRemainingTime(currentUser.uid);
            setError(`Search rate limit exceeded. Please wait ${remainingTime} seconds.`);
            ...
            >
                ...
                <div className="mb-6">
                    ...
                    <p className="text-gray-400 mt-2">
                        Enter your friend's username to send them a friend request. Usernames start with @.
                    </p>
                </div>
                ...
                {searchResult && (
                    <div className="mt-4 space-y-2 max-h-[60vh] overflow-y-auto pr-2">
                        <div className="group flex items-center justify-between p-4 border border-[#272727] rounded-xl 
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400">
                                        {searchResult.isAdded ? 'Already friends' : 
                                         searchResult.isPending ? 'Request pending' : 'User found'}
                                    </p>
                                </div>
                            </div>
