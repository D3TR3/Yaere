...
import { getPendingRequests, acceptFriendRequest, rejectFriendRequest } from '../firebase/firestore';
                ...
                <div className="max-h-[calc(100vh-16rem)] flex flex-col">
                    ...
                    {isLoading ? (
                        ...
                        <div className="text-center text-gray-400 py-8">
                            ...
                            <p className="text-sm mt-2">When someone adds you, they'll appear here</p>
                        </div>
                    ) : (
