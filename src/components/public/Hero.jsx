    ...
    return (
        <div className='max-w-[1240px] mx-auto px-4 py-16 border-x border-[#272727]'>
            <div className='flex flex-col items-center text-center'>
                ...
                <h1 className='text-5xl sm:text-6xl md:text-7xl font-bold mb-8 animate-fadeUp' style={{animationDelay: '100ms'}}>
                ...
                {/* Description */}
                <p className='text-gray-400 text-lg sm:text-xl max-w-[800px] mb-12 animate-fadeUp' style={{animationDelay: '200ms'}}>
                    Have you ever needed a fast and secure chat application? YAERE doesn't collect a SINGLE byte of your data.
                </p>
