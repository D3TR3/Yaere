...
import { doSignInWithEmailAndPassword, doSignInWithGoogle, doPasswordReset, getResetCooldownTime } from '../../firebase/auth';
...
const SignIn = ({ setShowSignIn, setShowSignUp }) => {
    ...
    return (
        ...
        >
            <div className='w-full max-w-[500px] bg-[#020202] rounded-lg relative border border-[#272727] 
            ...
            >
                ...
                <form onSubmit={handleSubmit} className='space-y-3 sm:space-y-4'>
                    {error && (
                        <p className='text-red-500 text-center bg-red-500/10 py-2 px-4 rounded-lg'>{error}</p>
                    )}
                    {resetEmailSent && (
