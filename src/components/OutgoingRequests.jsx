...
import { getOutgoingRequests, rejectFriendRequest } from '../firebase/firestore';
            ...
            >
                ...
                <div className="mb-6">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-white">Outgoing Requests</h2>
                ...
                <div className="max-h-[calc(100vh-16rem)] flex flex-col">
                    ...
                    {isLoading ? (
                        ...
                        <div className="text-center text-gray-400 py-8">
                            ...
                            <p className="text-sm mt-2">Friend requests you've sent will appear here</p>
                        </div>
                    ) : (
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-400">
                                                    Sent {new Date(request.requestTime.toDate()).toLocaleDateString()}
                                                </p>
                                            </div>
                                        </div>
                                        <button
